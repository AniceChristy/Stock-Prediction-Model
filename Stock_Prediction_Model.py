...
# y_predicted = tf.compat.v1.placeholder(tf.float32, name='y_predicted')
#
...
print("Welcome to Stock Prediction Model")

# Provide options for stock selection
...
# Mapping the user choice to the respective data files
stock_choices = {
    '1': ('CSV_Files/Gas Data Last Year.csv', 'CSV_Files/Gas Data Last Month.csv'),
    '2': ('CSV_Files/Gold Data Last Year.csv', 'CSV_Files/Gold Data Last Month.csv'),
    '3': ('CSV_Files/Oil Data Last Year.csv', 'CSV_Files/Oil Data Last Month.csv'),
    '4': ('CSV_Files/Silver Data Last Year.csv', 'CSV_Files/Silver Data Last Month.csv')
}

if choice in stock_choices:
    current_train_data, current_test_data = stock_choices[choice]
    train_final_prices, train_opening_prices, train_volumes = load_stock_data(current_train_data, 266)
    train_price_differences = calculate_price_differences(train_final_prices, train_opening_prices)
    train_volumes = train_volumes[:-1]

    test_final_prices, test_opening_prices, test_volumes = load_stock_data(current_test_data, 22)
    test_price_differences = calculate_price_differences(test_final_prices, test_opening_prices)
    test_volumes = test_volumes[:-1]
